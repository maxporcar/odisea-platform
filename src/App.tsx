...
import CountrySpecificCitiesIndex from "./pages/paises/[countryId]/ciudades/index";
        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/paises/:countryId/ciudades" element={<Layout><CountrySpecificCitiesIndex /></Layout>} />
              ...
              <Route path="/cities" element={<Layout><CitiesIndex /></Layout>} />
